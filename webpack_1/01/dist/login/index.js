...
;// ./src/login/assets/background.png
const background_namespaceObject = __webpack_require__.p + "assets/ca162aa839fe88baf6e0.png";
...
backgroundImg.style.background = `url(${background_namespaceObject}) no-repeat top/cover`
